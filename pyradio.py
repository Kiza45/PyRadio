...
schedule.every().monday.at("09:00").do(radioPlayScheduler())
schedule.every().tuesday.at("09:00").do(radioPlayScheduler())
schedule.every().wednesday.at("09:00").do(radioPlayScheduler())
schedule.every().thursday.at("09:00").do(radioPlayScheduler())
schedule.every().friday.at("09:00").do(radioPlayScheduler())
